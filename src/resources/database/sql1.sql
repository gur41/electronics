...
-- Schema electronic
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `electronic` DEFAULT CHARACTER SET utf8 ;
-- -----------------------------------------------------
-- Schema log
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `electronic`.`battery_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`battery_for_notebook` (
...
-- -----------------------------------------------------
-- Table `electronic`.`camera_sound_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`camera_sound_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`common_information_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`common_information_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`complectation_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`complectation_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`construction_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`construction_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`data_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`data_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`founctions_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`founctions_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`graphics_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`graphics_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`interface_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`interface_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`keyboard_and_touchpad_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`keyboard_and_touchpad_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`processor_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`processor_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`ram_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`ram_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(255) NULL DEFAULT NULL,
  `volume` INT(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
...
-- -----------------------------------------------------
-- Table `electronic`.`screen_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`screen_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`weight_and_size_for_notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`weight_and_size_for_notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `electronic`.`notebook`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `electronic`.`notebook` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `id_battery_for_notebook`
    ...
    REFERENCES `electronic`.`battery_for_notebook` (`id`),
  CONSTRAINT `id_camera_sound_for_notebook`
    FOREIGN KEY (`id_camera_sound_for_notebook`)
    REFERENCES `electronic`.`camera_sound_for_notebook` (`id`),
  CONSTRAINT `id_common_information_for_notebook`
    FOREIGN KEY (`id_common_information_for_notebook`)
    REFERENCES `electronic`.`common_information_for_notebook` (`id`),
  CONSTRAINT `id_complectation_for_notebook`
    FOREIGN KEY (`id_complectation_for_notebook`)
    REFERENCES `electronic`.`complectation_for_notebook` (`id`),
  CONSTRAINT `id_construction_for_notebook`
    FOREIGN KEY (`id_construction_for_notebook`)
    REFERENCES `electronic`.`construction_for_notebook` (`id`),
  CONSTRAINT `id_data_for_notebook`
    FOREIGN KEY (`id_data_for_notebook`)
    REFERENCES `electronic`.`data_for_notebook` (`id`),
  CONSTRAINT `id_founctions_for_notebook`
    FOREIGN KEY (`id_founctions_for_notebook`)
    REFERENCES `electronic`.`founctions_for_notebook` (`id`),
  CONSTRAINT `id_graphics_for_notebook`
    FOREIGN KEY (`id_graphics_for_notebook`)
    REFERENCES `electronic`.`graphics_for_notebook` (`id`),
  CONSTRAINT `id_interface_for_notebook`
    FOREIGN KEY (`id_interface_for_notebook`)
    REFERENCES `electronic`.`interface_for_notebook` (`id`),
  CONSTRAINT `id_keyboard_and_touchpad_for_notebook`
    FOREIGN KEY (`id_keyboard_and_touchpad_for_notebook`)
    REFERENCES `electronic`.`keyboard_and_touchpad_for_notebook` (`id`),
  CONSTRAINT `id_proceessor_for_notebook`
    FOREIGN KEY (`id_processor_for_notebook`)
    REFERENCES `electronic`.`processor_for_notebook` (`id`),
  CONSTRAINT `id_ram_for_notebook`
    FOREIGN KEY (`id_ram_for_notebook`)
    REFERENCES `electronic`.`ram_for_notebook` (`id`),
  CONSTRAINT `id_screen_for_notebook`
    FOREIGN KEY (`id_screen_for_notebook`)
    REFERENCES `electronic`.`screen_for_notebook` (`id`),
  CONSTRAINT `id_weight_and_size_for_notebook`
    FOREIGN KEY (`id_weight_and_size_for_notebook`)
    REFERENCES `electronic`.`weight_and_size_for_notebook` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE INDEX `id_complectation_for_notebook` ON `electronic`.`notebook` (`id_complectation_for_notebook` ASC);

CREATE INDEX `id_battery_for_notebook` ON `electronic`.`notebook` (`id_battery_for_notebook` ASC);

CREATE INDEX `id_interface_for_notebook` ON `electronic`.`notebook` (`id_interface_for_notebook` ASC);

CREATE INDEX `id_founctions_for_notebook` ON `electronic`.`notebook` (`id_founctions_for_notebook` ASC);

CREATE INDEX `id_keyboard_and_touchpad_for_notebook` ON `electronic`.`notebook` (`id_keyboard_and_touchpad_for_notebook` ASC);

CREATE INDEX `id_camera_sound_for_notebook` ON `electronic`.`notebook` (`id_camera_sound_for_notebook` ASC);

CREATE INDEX `id_graphics_for_notebook` ON `electronic`.`notebook` (`id_graphics_for_notebook` ASC);

CREATE INDEX `id_data_for_notebook` ON `electronic`.`notebook` (`id_data_for_notebook` ASC);

CREATE INDEX `id_ram_for_notebook` ON `electronic`.`notebook` (`id_ram_for_notebook` ASC);

CREATE INDEX `id_weight_and_size_for_notebook` ON `electronic`.`notebook` (`id_weight_and_size_for_notebook` ASC);

CREATE INDEX `id_screen_for_notebook` ON `electronic`.`notebook` (`id_screen_for_notebook` ASC);

CREATE INDEX `id_common_information_for_notebook` ON `electronic`.`notebook` (`id_common_information_for_notebook` ASC);

CREATE INDEX `id_proceessor_for_notebook` ON `electronic`.`notebook` (`id_processor_for_notebook` ASC);

CREATE INDEX `id_construction_for_notebook` ON `electronic`.`notebook` (`id_construction_for_notebook` ASC);
...
-- -----------------------------------------------------
-- Table `mydb`.`equipmrnt`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`equipmrnt` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `ram` DOUBLE NULL DEFAULT NULL,
  `quantityCore` INT(11) NULL DEFAULT NULL,
  `speed` INT(11) NULL DEFAULT NULL,
  `Mobil_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`, `Mobil_id`),
  CONSTRAINT `fk_equipmrnt_Mobil`
    FOREIGN KEY (`Mobil_id`)
    REFERENCES `mydb`.`mobil` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE INDEX `fk_equipmrnt_Mobil_idx` ON `mydb`.`equipmrnt` (`Mobil_id` ASC);
...
CREATE TABLE IF NOT EXISTS `mydb`.`person` (
  ...
  `birthdday` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`letter` (
  ...
  `idResev` VARCHAR(45) NULL DEFAULT NULL,
  `title` VARCHAR(45) NULL DEFAULT NULL,
  `text` VARCHAR(45) NULL DEFAULT NULL,
  `timeSent` VARCHAR(45) NULL DEFAULT NULL,
  `person_idperson` INT(11) NOT NULL,
  PRIMARY KEY (`idletter`),
  CONSTRAINT `fk_letter_person`
...
CREATE INDEX `fk_letter_person_idx` ON `mydb`.`letter` (`person_idperson` ASC);
...
CREATE TABLE IF NOT EXISTS `mydb`.`order` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `numberOrder` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
