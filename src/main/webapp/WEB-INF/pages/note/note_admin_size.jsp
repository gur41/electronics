            ...
            <div class="row otstup">
                <div class="col-md-12">
                    ...
                    <section class="main">
                        ...
                        <c:url var="addAction" value="/note_admin_size/add"/>

                        <form:form action="${addAction}" modelAttribute="size" class="form-horizontal">


                        <div class="form-group">
                            <form:label path="width" class="col-sm-2 control-label">
                                <spring:message text="Ширина"/>
                            </form:label>
                            <div class="col-sm-4">
                                <form:input path="width" pattern="(.[0-9]*)"
                                            title="Используйте цифры." class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <form:label path="depth" class="col-sm-2 control-label">
                                <spring:message text="Глубина"/>
                            </form:label>
                            <div class="col-sm-4">
                                <form:input path="depth" pattern="(.[0-9]*)"
                                            title="Используйте цифры." class="form-control"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <form:label path="thickness" class="col-sm-2 control-label">
                                <spring:message text="Толщина"/>
                            </form:label>
                            <div class="col-sm-4">
                                <form:input path="thickness" pattern="(.[0-9]*)"
                                            title="Используйте цифры." class="form-control"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <form:input path="weight" pattern="(.[0-9]*)"
                                            title="Используйте цифры." class="form-control"/>
                            </div>
                        </div>
