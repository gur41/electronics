            ...
            <div class="row otstup">
                <div class="col-md-12">
                    ...
                    <section class="main">
                        ...
                        <c:url var="addAction" value="/note_admin_graphics/add"/>

                        <form:form action="${addAction}" modelAttribute="graphics" class="form-horizontal">


                        <div class="form-group">
                            <form:label path="adapter" class="col-sm-2 control-label">
                        ...
                        <div class="form-group">
                            <form:label path="type" class="col-sm-2 control-label">
                                <spring:message text="Тип графического адаптера"/>
                            </form:label>
                            <div class="col-sm-4">
