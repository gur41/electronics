...
@Entity
@Table(name = "ram_for_notebook", schema = "log", catalog = "")
public class RamForNotebook {
    private Integer id;
    private String type;
    ...
    public boolean equals(Object o) {
        ...
        RamForNotebook that = (RamForNotebook) o;
    ...
    @OneToMany(mappedBy = "ramForNotebookByIdRamForNotebook")
